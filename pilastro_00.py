"""
    ...
    Descrizione:    Costruzione di un pilastro in ca
                    (base per pilastri con armatura )
...
FreeCAD.ActiveDocument.Label='pilastro_00'

App.setLogLevel('pilastro_00', 'Trace')
#App.setLogLevel('pilastro_00', 'Log')
#App.setLogLevel('pilastro_00', 'Message')
log=App.Logger('pilastro_00')
